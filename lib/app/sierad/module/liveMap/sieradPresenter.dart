...
mixin SieradPresenter on PresenterState {
  SieradViewModel viewModel = new SieradViewModel();
  ...
  void setFirstSelected() {
    ...
    var single = TmsShipmentModel.fromJson<SieradShipmentDetailHatcheryModel>(
        viewModel.shipment.first.toJson(), childReader: (json) {
  ...
  void setSelectedShipment(
      TmsShipmentModel<SieradShipmentDetailHatcheryModel> selected) {
