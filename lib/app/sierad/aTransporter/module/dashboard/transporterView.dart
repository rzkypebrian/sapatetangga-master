...
import 'package:enerren/app/sierad/aTransporter/module/dashboard/transporterPresenter.dart';
...
class TransporterView extends SieradView with TransporterPresenter {
          ...
          children: <Widget>[
            ...
            Align(
              ...
              child: Padding(
                ...
                child: Text(
                  "${value != null ? value > 99 ? "99+" : value : "0"}",
      ...
      child: Stack(
        children: <Widget>[
          Align(
            ...
            child: SvgPicture.asset("assets/sierad/transporter_egg_3.svg"),
          ),
          Align(
            alignment: Alignment.bottomRight,
            child: SvgPicture.asset("assets/sierad/transporter_egg_4.svg"),
          ),
          Align(
            alignment: Alignment.bottomCenter,
            child: Padding(
