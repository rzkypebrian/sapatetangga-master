...
import 'package:enerren/app/sierad/aAdmin/module/checkUser/main.dart'
    as checkUser;
import 'package:enerren/app/sierad/aAdmin/module/login/main.dart' as login;
...
import 'package:enerren/app/sierad/aAdmin/module/dashboard/main.dart'
    as dashboard;
...
import 'package:enerren/app/sierad/aAdmin/module/profile/main.dart' as profile;
...
import 'package:enerren/app/sierad/aAdmin/module/splashScreen/main.dart'
    as splashScreen;
    ...
    return detailHistory.Presenter(
      ...
      onTapViewPod: (pod) {
        System.data.routes.pushNamed(context, RouteName.pod, arguments: {
          ParamName.TmsDeleveryPodModel: pod,
        });
      },
    );
  },
  ...
  RouteName.pod: (BuildContext context) {
    ...
    return pod.Presenter(
      view: pod.ReadOnlyView(
        deliveryPodModel: arg[ParamName.TmsDeleveryPodModel],
      ),
    );
  }
};
