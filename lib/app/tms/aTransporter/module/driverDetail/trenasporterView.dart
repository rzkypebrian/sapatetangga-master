import 'package:enerren/app/tms/aTransporter/module/driverDetail/transporterPresenter.dart';
...
class TransPorterView<T> extends View with TransPorterPresenter {
  final List<TmsShipmentModel> dataShipment;
  final ValueChanged<TmsShipmentModel<T>> onTapDetailShipment;
