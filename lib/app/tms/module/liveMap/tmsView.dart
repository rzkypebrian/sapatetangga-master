...
import 'package:enerren/app/tms/module/liveMap/tmsPresenter.dart';
...
class TmsView<T> extends View with TmsPresenter, TickerProviderStateMixin {
  ...
  Widget contentPage2() {
    return VehicleInfoDecoration.popupMapVehicleInfo(
      ...
      topLeftWidget: tmsViewModel.selectedShipment != null
          ? GestureDetector(
              onTap: () {
                if (onTapDetailOrder != null) {
                  onTapDetailOrder(viewModel.selectedShipment);
            ...
            child: Row(
              ...
              children: <Widget>[
                ...
                MenuComponent.circleMenu(
                  ...
                  backgroundColor: Colors.white,
                  textMenuSpace: 85,
                  menu: SvgPicture.asset("assets/tms/icon_map.svg"),
                  onTap: () {
                    openMap(true);
                  },
                ),
