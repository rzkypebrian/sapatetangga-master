...
class DetailInpunBill extends PresenterState {
  @override
  ...
  Widget resultInput(ViewModel vm) {
    return Container(
          ...
          Container(
            ...
            child: Row(
              children: <Widget>[
                ...
                Expanded(child: Container(child: Text('${vm.bank}'))),
              ],
            ),
          ),
          Container(
            ...
            child: Row(
              children: <Widget>[
                ...
                Expanded(child: Container(child: Text('${vm.angkutBill.accountNumber}'))),
              ],
            ),
          ),
          Container(
            ...
            child: Row(
              children: <Widget>[
                ...
                Expanded(child: Container(child: Text('${vm.angkutBill.accounHolderName}'))),
              ],
            ),
          ),
          Container(
            ...
            child: Row(
              children: <Widget>[
                ...
                Expanded(child: Container(child: Text('${vm.angkutBill.datePay}'))),
              ],
            ),
          ),
          Container(
            ...
            child: Row(
              children: <Widget>[
                ...
                Expanded(child: Container(child: Text('${vm.angkutBill.debtTotal}'))),
              ],
            ),
          ),
        ],
