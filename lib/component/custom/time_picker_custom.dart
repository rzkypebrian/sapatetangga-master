...
class _DayPeriodControl extends StatelessWidget {
  ...
  void _setAm(BuildContext context) {
    ...
    if (fragmentContext.targetPlatform == TargetPlatform.android) {
      _announceToAccessibility(
          context, MaterialLocalizations.of(context).anteMeridiemAbbreviation);
    }
    _togglePeriod();
  }
  ...
  void _setPm(BuildContext context) {
    ...
    if (fragmentContext.targetPlatform == TargetPlatform.android) {
      _announceToAccessibility(
          context, MaterialLocalizations.of(context).postMeridiemAbbreviation);
    }
    _togglePeriod();
  }
...
_TimePickerHeaderFormat _buildHeaderFormat(TimeOfDayFormat timeOfDayFormat,
    _TimePickerFragmentContext context, Orientation orientation) {
...
class _TimePickerHeader extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    activeColor = headerActiveColor ?? activeColor;
    inactiveColor = headerInActiveColor ?? inactiveColor;
...
class _DialState extends State<_Dial> with SingleTickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    backgroundColor = widget.pickerBackgroundColor ?? backgroundColor;
    ...
    return GestureDetector(
      ...
      child: CustomPaint(
        ...
        painter: _DialPainter(
          ...
          accentColor: widget.selcetorColor ?? themeData.accentColor,
          theta: _theta.value,
...
class _TimePickerDialogState extends State<_TimePickerDialog> {
  ...
  Widget build(BuildContext context) {
    ...
    final bool use24HourDials = widget.use24HourDials ??
    ...
    final Widget picker = Padding(
      ...
      child: AspectRatio(
        ...
        child: _Dial(
          ...
          selcetorColor: widget.selcetorColor,
        ),
      ),
    );
    ...
    final Widget actions = ButtonBar(
      children: <Widget>[
        FlatButton(
          ...
          child: Text(
            widget.okBtnTitle ?? localizations.cancelButtonLabel,
            style: widget.okBtnStyle,
          ),
        ...
        FlatButton(
          ...
          child: Text(
            widget.cancelBtnTitle ?? localizations.okButtonLabel,
            style: widget.cancelBtnStyle,
          ),
          onPressed: _handleOk,
        ),
      ],
    ...
    final Dialog dialog = Dialog(
      child: OrientationBuilder(
        ...
        final Widget header = _TimePickerHeader(
          ...
          onChanged: _handleTimeChanged,
          use24HourDials: use24HourDials,
          headerActiveColor: widget.headerActiveColor,
          headerBackgroundColor: widget.headerBackgroundColor,
          headerInActiveColor: widget.headerInActiveColor,
        );
...
Future<TimeOfDay> showTimePicker({
  ...
  final Widget dialog = _TimePickerDialog(
    ...
    headerInActiveColor: headerInActiveColor,
    labelStyle: labelStyle,
    pickerBackgroundColor: pickerBackgroundColor,
    selcetorColor: selcetorColor,
  );
