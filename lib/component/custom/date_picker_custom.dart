...
class _DatePickerHeader extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    backgroundColor = backgroundHeader ?? backgroundColor;
    ...
    labels.addAll(_getDayHeaders(
        textHeaderStyle ??
            themeData.textTheme.caption.copyWith(
                color: textHeaderColor ?? themeData.textTheme.caption.color),
        localizations));
          ...
          PositionedDirectional(
            ...
            child: Semantics(
              ...
              child: FadeTransition(
                ...
                child: IconButton(
                  icon: Icon(
                    widget.iconBack ?? Icons.chevron_left,
          ...
          PositionedDirectional(
            ...
            child: Semantics(
              ...
              child: FadeTransition(
                ...
                child: IconButton(
                  icon: Icon(
                    widget.iconNext ?? Icons.chevron_right,
                    color: widget.iconNextColor,
                  ),
...
class _DatePickerDialog extends StatefulWidget {
  const _DatePickerDialog({
    ...
    this.cancleTextStyle = const TextStyle(
      color: Colors.black,
    ),
  ...
  Widget build(BuildContext context) {
    ...
    final Widget actions = ButtonBar(
      children: <Widget>[
        FlatButton(
          child: Text(
            widget.cancleText ?? localizations.cancelButtonLabel,
            style: widget.cancleTextStyle,
          ),
          onPressed: _handleCancel,
        ),
        FlatButton(
          child: Text(
            widget.okText ?? localizations.okButtonLabel,
    ...
    final Dialog dialog = Dialog(
      child: OrientationBuilder(
        ...
        final Widget header = _DatePickerHeader(
          ...
          backgroundHeader: widget.backgroundHeader,
          dayColor: widget.dayColor,
          dayStyles: widget.dayStyles,
          yearColor: widget.yearColor,
          yearStyles: widget.yearStyles,
        );
        switch (orientation) {
          case Orientation.portrait:
            return Container(
...
Future<DateTime> showDatePicker({
  ...
  Widget child = _DatePickerDialog(
    ...
    cancleTextStyle: cancleTextStyle,
