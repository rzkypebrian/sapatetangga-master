...
class CountryModel {
  ...
  factory CountryModel.fromJson(Map<String, dynamic> data) {
    return CountryModel(
        ...
        enShortName: data['en_short_name'],
  ...
  static List<CountryModel> fromListJson(List<Map<String, dynamic>> jsons) {
    return jsons.map((e) => new CountryModel.fromJson(e)).toList();
  }
  ...
  static List<CountryModel> getCountries({
    ...
    var jsonList = CountryModel.countries;
    switch (searchKey) {
      case SearchKey.numCode:
        return CountryModel.fromListJson(jsonList)
            .where((x) =>
                x.numCode.toUpperCase().contains(filterKey.toUpperCase()))
            .toList();
        break;
      case SearchKey.alpha2code:
        return CountryModel.fromListJson(jsonList)
            .where((x) =>
                x.alpha2code.toUpperCase().contains(filterKey.toUpperCase()))
            .toList();
        break;
      case SearchKey.alpha3code:
        return CountryModel.fromListJson(jsonList)
            .where((x) =>
                x.alpha3code.toUpperCase().contains(filterKey.toUpperCase()))
            .toList();
        break;
      case SearchKey.enShortName:
        return CountryModel.fromListJson(jsonList)
            .where((x) =>
                x.enShortName.toUpperCase().contains(filterKey.toUpperCase()))
            .toList();
        break;
      case SearchKey.nationality:
        return CountryModel.fromListJson(jsonList)
            .where((x) =>
                x.nationality.toUpperCase().contains(filterKey.toUpperCase()))
            .toList();
        break;
      case SearchKey.dialCode:
        return CountryModel.fromListJson(jsonList)
            .where((x) =>
                x.dialCode.toUpperCase().contains(filterKey.toUpperCase()))
            .toList();
        break;
      default:
        return CountryModel.fromListJson(jsonList);
  ...
  static CountryModel getInitialSelectedCountry(
      List<CountryModel> countries, String countryCode) {
