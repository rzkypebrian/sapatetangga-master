...
class ShipmentItemDescriptionViewModel {
  ...
  static Future<List<ShipmentItemDescriptionViewModel>>
    ...
    return _netUtil.get(
      System.data.apiEndPointUtil
          .loadingItemShipmentDescriotion(tmsShipmentId: tmsShipmentId),
      headers: {
        "lang": "${System.data.resource.lang}",
        HttpHeaders.authorizationHeader: "bearer $token",
        HttpHeaders.contentTypeHeader: "application/json",
  ...
  static Future<List<ShipmentItemDescriptionViewModel>>
    ...
    @required String token,
    @required int tmsShipmentId,
    @required int detailDestinationId,
  }) {
    NetworkUtil _netUtil = new NetworkUtil();
    return _netUtil.get(
      System.data.apiEndPointUtil.unloadingItemShipmentDescriotion(
